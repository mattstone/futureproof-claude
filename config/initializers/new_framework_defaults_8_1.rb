...
#++
# Performance: Skip escaping HTML entities in JSON (modern browsers handle this)
...
#++
# Security: Raise on potentially unsafe relative redirects (prevents open redirect vulnerabilities)
...
#++
# Performance: Remove unnecessary autocomplete="off" from hidden fields
